...
def test_ov(
    ...
    test_auc,  test_accuracy, eval_time, num_iters = eval_ov(test_data, compiled_model)
...
def eval_ov(test_data, compiled_model):
    loss_sum = 0.
    accuracy_sum = 0.
    aux_loss_sum = 0.
    nums = 0
...
if __name__ == '__main__':
    ...
    if args.mode == 'train':
        ...
        if args.backend == "tensorflow":
            print("Test DIEN with Tensorflow backend")
